...
namespace MdTZ
{
    public class THSAPI
    {
        ...
        * */
        ...
        public const string NUM_OPT_50 = "1";     //输入
        public const string NUM_OPT_30 = "2";     //输入
        public const string NUM_OPT_25 = "3";     //输入
        public const string NUM_OPT_20 = "4";     //输入
      ...
      * */
       ...
       *最大化，最小号，交易窗口
       * */
        public static int activeTranWin(string chgOpt)
        {
            if ("min".Equals(chgOpt))
            {
                //最小化
                WinAPI.mouse_event(WinAPI.MOUSEEVENTF_ABSOLUTE | WinAPI.MOUSEEVENTF_MOVE, 63500, 500, 0, 0);
                WinAPI.mouse_event(WinAPI.MOUSEEVENTF_LEFTDOWN | WinAPI.MOUSEEVENTF_LEFTUP, 1, 1, 0, 0);

                Thread.Sleep(300);
            }
            else if ("max".Equals(chgOpt))
            {
                //最大化
                WinAPI.mouse_event(WinAPI.MOUSEEVENTF_ABSOLUTE | WinAPI.MOUSEEVENTF_MOVE, 6000, 60800, 0, 0);
                WinAPI.mouse_event(WinAPI.MOUSEEVENTF_LEFTDOWN | WinAPI.MOUSEEVENTF_LEFTUP, 1, 1, 0, 0);
        ...
        {
            //撤单
            WinAPI.mouse_event(WinAPI.MOUSEEVENTF_ABSOLUTE | WinAPI.MOUSEEVENTF_MOVE, 8000, 3000, 0, 0);
            WinAPI.mouse_event(WinAPI.MOUSEEVENTF_LEFTDOWN | WinAPI.MOUSEEVENTF_LEFTUP, 1, 1, 0, 0);           
            return 0;
        }
    }
